...
radar-section-help = ثلاث قراءات لما يحتويه هذا السجل، كل محور من 0 إلى 100. كل رقم يُحسب من الوقائع المذكورة بجانبه، وفق قواعد مكتوبة في توثيق التطبيق؛ لا يُحفظ شيء ولا يُخمَّن شيء، والمحور الذي لا يوجد ما يُقرأ منه يُترك فارغًا بدل أن يُعطى درجة وسطى. تبيّن العلامات والأشرطة مدى اليقين في كل رقم: النقطة الممتلئة شبه مؤكدة، والنقطة داخل حلقة مدعومة جيدًا، والحلقة مرجَّحة، والحلقة المتقطعة تخمين، وكلما طال الشريط قلّ اليقين.
