...
tree-contradicts-detail = أحدهم مسجَّل سلفًا لنفسه، أو أن شخصين على خط نسب واحد مسجَّلان زوجين. ولا ترتيب للصفوف يفي بذلك، فتُركت الصلة المعنية خارج ترقيم الأجيال وقد تكون بعض الصفوف خاطئة. شغّل التحقق من لوحة الإدارة للعثور عليها.
