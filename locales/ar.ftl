...
phys-section-title = البدن والصحة
phys-section-help = ما يذكره السجل عن بدن الشخص وما يذكره عن صحته. لكل مُدخَل تاريخ قياسه أو الإبلاغ عنه، لأن طولًا في العشرين وطولًا في السادسة والخمسين واقعتان لا واقعة صُحِّحت.
phys-editor-title = البدن والصحة
phys-traits-title = السمات البدنية
phys-traits-help = ما يدوّنه جواز سفر أو سجل تجنيد أو ملف سجن. ليست بيانات طبية ولا تُعامَل معاملتها.
phys-health-title = الصحة والمعتقد
phys-health-help = الأمراض والعمليات وسبب الوفاة والدين أو الانتماء. لدى شخص على قيد الحياة تُحفظ هذه ولا يراها إلا المديرون.
phys-living-warning = هذه بيانات صحية عن شخص على قيد الحياة. ستُحفظ في الحزمة، ولن يراها إلا المديرون — لا بقية أفراد الأسرة المسجَّلين ولا الزوار — إلى أن يُعلَّم السجل بالوفاة.
phys-living-shown-note = تراها لأنك مدير؛ غيرك من القرّاء لا يراها.
phys-health-withheld = بيانات هذا الشخص الصحية مسجَّلة لكنها محجوبة.
phys-health-withheld-editor = بيانات هذا الشخص الصحية محجوبة عنك، فلا تظهر هنا، وحفظ هذه الاستمارة يتركها كما هي.
phys-health-locked-title = ليس لك تغيير هذه البيانات الصحية
phys-health-locked-detail = يحمل هذا السجل بيانات صحية لا يحق لك قراءتها، فلا يمكن تعديلها من استمارة لم تعرضها. يستطيع مدير إجراء التغيير.
phys-edit-link = تحرير البدن والصحة
phys-undated = بلا تاريخ
phys-no-source = بلا مصدر
phys-date-placeholder = 1914 أو 1914-08
phys-col-value = القيمة
phys-col-date = متى
...
phys-unit-cm = { $n } سم
phys-unit-kg = { $n } كجم
phys-unit-cm-short = سم
phys-unit-kg-short = كجم
phys-error-number = الطول والوزن عددان صحيحان: سنتيمترات، كيلوغرامات.
phys-error-range = هذا الطول أو الوزن خارج ما يمكن أن يعنيه سجل.
phys-error-vocabulary = ليست هذه إحدى القيم المذكورة.
phys-error-confidence = تتراوح الثقة من 0 إلى 1، مثلًا 0.8.
...
phys-eye-colour-brown = بنيتان
phys-eye-colour-hazel = عسليتان
phys-eye-colour-amber = كهرمانيتان
phys-eye-colour-green = خضراوان
phys-eye-colour-blue = زرقاوان
phys-eye-colour-grey = رماديتان
phys-eye-colour-mixed = مختلطتان
phys-eye-colour-other = غير ذلك
phys-hair-colour-black = أسود
phys-hair-colour-brown = بني
phys-hair-colour-auburn = كستنائي
phys-hair-colour-red = أحمر
phys-hair-colour-fair = فاتح
phys-hair-colour-blond = أشقر
phys-hair-colour-grey = رمادي
phys-hair-colour-white = أبيض
phys-hair-colour-none = لا شعر
phys-hair-colour-other = غير ذلك
phys-build-slight = نحيلة
phys-build-slim = رشيقة
phys-build-average = متوسطة
phys-build-sturdy = قوية
phys-build-stout = ممتلئة
phys-build-heavy = ثقيلة
phys-handedness-left = أعسر
phys-handedness-right = أيمن
phys-handedness-ambidextrous = يستعمل اليدين
phys-handedness-unknown = غير معروفة
phys-blood-group-a-pos = A موجب
phys-blood-group-a-neg = A سالب
phys-blood-group-b-pos = B موجب
phys-blood-group-b-neg = B سالب
phys-blood-group-ab-pos = AB موجب
phys-blood-group-ab-neg = AB سالب
