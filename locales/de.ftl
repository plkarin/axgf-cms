...
phys-section-title = Körper und Gesundheit
phys-section-help = Was ein Eintrag über den Körper eines Menschen aussagt und was über seine Gesundheit. Jeder Eintrag trägt das Datum der Messung oder Meldung, denn eine Größe mit zwanzig und eine mit sechsundfünfzig sind zwei Tatsachen und nicht eine berichtigte.
phys-editor-title = Körper und Gesundheit
phys-traits-title = Körperliche Merkmale
phys-traits-help = Was ein Pass, eine Musterungsliste oder eine Gefängnisakte festhält. Keine medizinischen Daten, und hier auch nicht so behandelt.
phys-health-title = Gesundheit und Bekenntnis
phys-health-help = Erkrankungen, Operationen, Todesursache sowie Religion oder Zugehörigkeit. Bei einer lebenden Person werden diese gespeichert, aber nur Administratoren gezeigt.
phys-living-warning = Dies sind Gesundheitsdaten über einen lebenden Menschen. Sie werden im Bündel gespeichert, und bis der Eintrag als verstorben gekennzeichnet ist, sehen sie ausschließlich Administratoren — nicht die übrige angemeldete Familie und keine Besucher.
phys-living-shown-note = Sie sehen dies, weil Sie Administrator sind; andere Lesende sehen es nicht.
phys-health-withheld = Die Gesundheitsangaben dieser Person sind erfasst, aber zurückgehalten.
phys-health-withheld-editor = Die Gesundheitsangaben dieser Person sind Ihnen vorenthalten, werden hier also nicht gezeigt, und das Speichern dieses Formulars lässt sie unverändert.
phys-health-locked-title = Diese Gesundheitsangaben dürfen Sie nicht ändern
phys-health-locked-detail = Dieser Eintrag enthält Gesundheitsdaten, die Sie nicht lesen dürfen, also lassen sie sich nicht über ein Formular ändern, das sie nicht angezeigt hat. Ein Administrator kann die Änderung vornehmen.
phys-edit-link = Körper und Gesundheit bearbeiten
phys-undated = ohne Datum
phys-no-source = ohne Quelle
phys-date-placeholder = 1914 oder 1914-08
phys-col-value = Wert
phys-col-date = Wann
...
phys-error-number = Größe und Gewicht sind ganze Zahlen: Zentimeter, Kilogramm.
phys-error-range = Diese Größe oder dieses Gewicht liegt außerhalb dessen, was ein Eintrag meinen könnte.
phys-error-vocabulary = Das ist keiner der aufgeführten Werte.
phys-error-confidence = Die Sicherheit reicht von 0 bis 1, zum Beispiel 0,8.
...
phys-eye-colour-brown = braun
phys-eye-colour-hazel = haselnussbraun
phys-eye-colour-amber = bernsteinfarben
phys-eye-colour-green = grün
phys-eye-colour-blue = blau
phys-eye-colour-grey = grau
phys-eye-colour-mixed = gemischt
phys-eye-colour-other = andere
phys-hair-colour-black = schwarz
phys-hair-colour-brown = braun
phys-hair-colour-auburn = kastanienbraun
phys-hair-colour-red = rot
phys-hair-colour-fair = hell
phys-hair-colour-blond = blond
phys-hair-colour-grey = grau
phys-hair-colour-white = weiß
phys-hair-colour-none = keine
phys-hair-colour-other = andere
phys-build-slight = zart
phys-build-slim = schlank
phys-build-average = mittel
phys-build-sturdy = kräftig
phys-build-stout = stämmig
phys-build-heavy = schwer
phys-handedness-left = linkshändig
phys-handedness-right = rechtshändig
phys-handedness-ambidextrous = beidhändig
phys-handedness-unknown = unbekannt
phys-blood-group-a-pos = A positiv
phys-blood-group-a-neg = A negativ
phys-blood-group-b-pos = B positiv
phys-blood-group-b-neg = B negativ
phys-blood-group-ab-pos = AB positiv
phys-blood-group-ab-neg = AB negativ
