...
phys-section-title = Body and health
phys-section-help = What a record states about a person's body, and what it states about their health. Every entry carries the date it was measured or reported, because a height at twenty and a height at fifty-six are two facts rather than one revised.
phys-editor-title = Body and health
phys-traits-title = Physical traits
phys-traits-help = What a passport, a conscription register or a prison record puts on the page. Not medical data, and not treated as such.
phys-health-title = Health and beliefs
phys-health-help = Conditions, operations, cause of death, and religion or affiliation. On a living person these are stored but shown to administrators only.
phys-living-warning = This is health data about someone living. It will be stored in the bundle, and only administrators will see it — not other signed-in family, and not visitors — until the record is marked deceased.
phys-living-shown-note = You are seeing this because you are an administrator; other readers are not.
phys-health-withheld = This person's health details are recorded but withheld.
phys-health-withheld-editor = This person's health details are withheld from you, so they are not shown here and saving this form will leave them untouched.
phys-health-locked-title = Health details are not yours to change
phys-health-locked-detail = This record carries health data you may not read, so it cannot be edited from a form that did not show it. An administrator can make the change.
phys-edit-link = Edit body and health
phys-undated = undated
phys-no-source = no source
phys-date-placeholder = 1914 or 1914-08
phys-col-value = Value
phys-col-date = When
...
phys-error-number = A height or weight is a whole number: centimetres, kilograms.
phys-error-range = That height or weight is outside anything a record could mean.
phys-error-vocabulary = That is not one of the listed values.
phys-error-confidence = Confidence runs from 0 to 1, for example 0.8.
...
phys-eye-colour-brown = brown
phys-eye-colour-hazel = hazel
phys-eye-colour-amber = amber
phys-eye-colour-green = green
phys-eye-colour-blue = blue
phys-eye-colour-grey = grey
phys-eye-colour-mixed = mixed
phys-eye-colour-other = other
phys-hair-colour-black = black
phys-hair-colour-brown = brown
phys-hair-colour-auburn = auburn
phys-hair-colour-red = red
phys-hair-colour-fair = fair
phys-hair-colour-blond = blond
phys-hair-colour-grey = grey
phys-hair-colour-white = white
phys-hair-colour-none = none
phys-hair-colour-other = other
phys-build-slight = slight
phys-build-slim = slim
phys-build-average = average
phys-build-sturdy = sturdy
phys-build-stout = stout
phys-build-heavy = heavy
phys-handedness-left = left-handed
phys-handedness-right = right-handed
phys-handedness-ambidextrous = ambidextrous
phys-handedness-unknown = unknown
phys-blood-group-a-pos = A positive
phys-blood-group-a-neg = A negative
phys-blood-group-b-pos = B positive
phys-blood-group-b-neg = B negative
phys-blood-group-ab-pos = AB positive
phys-blood-group-ab-neg = AB negative
