...
phys-section-title = Cuerpo y salud
phys-section-help = Lo que la ficha dice del cuerpo de una persona y lo que dice de su salud. Cada entrada lleva la fecha en que se midió o se informó, porque una estatura a los veinte y otra a los cincuenta y seis son dos hechos y no uno corregido.
phys-editor-title = Cuerpo y salud
phys-traits-title = Rasgos físicos
phys-traits-help = Lo que anotan un pasaporte, un registro de quintas o un expediente penitenciario. No son datos médicos ni se tratan como tales.
phys-health-title = Salud y creencias
phys-health-help = Dolencias, operaciones, causa de la muerte y religión o afiliación. En una persona viva se guardan pero solo las ven los administradores.
phys-living-warning = Estos son datos de salud de una persona viva. Se guardarán en el archivo y, hasta que la ficha se marque como fallecida, solo los verán los administradores: ni el resto de la familia con sesión iniciada ni los visitantes.
phys-living-shown-note = Ve esto porque es administrador; los demás lectores no.
phys-health-withheld = Los datos de salud de esta persona constan pero están reservados.
phys-health-withheld-editor = Los datos de salud de esta persona le están reservados, así que no se muestran aquí y guardar este formulario los dejará intactos.
phys-health-locked-title = Estos datos de salud no le corresponde cambiarlos
phys-health-locked-detail = Esta ficha contiene datos de salud que usted no puede leer, así que no pueden editarse desde un formulario que no los mostró. Un administrador puede hacer el cambio.
phys-edit-link = Editar cuerpo y salud
phys-undated = sin fecha
phys-no-source = sin fuente
phys-date-placeholder = 1914 o 1914-08
phys-col-value = Valor
...
phys-unit-cm = { $n } cm
phys-unit-kg = { $n } kg
phys-unit-cm-short = cm
phys-unit-kg-short = kg
phys-error-number = Una estatura o un peso es un número entero: centímetros, kilogramos.
phys-error-range = Esa estatura o ese peso queda fuera de lo que una ficha podría querer decir.
phys-error-vocabulary = Ese no es uno de los valores de la lista.
phys-error-confidence = La confianza va de 0 a 1, por ejemplo 0,8.
...
phys-eye-colour-brown = marrones
phys-eye-colour-hazel = avellana
phys-eye-colour-amber = ámbar
phys-eye-colour-green = verdes
phys-eye-colour-blue = azules
phys-eye-colour-grey = grises
phys-eye-colour-mixed = mezclados
phys-eye-colour-other = otro
phys-hair-colour-black = negro
phys-hair-colour-brown = castaño
phys-hair-colour-auburn = caoba
phys-hair-colour-red = pelirrojo
phys-hair-colour-fair = claro
phys-hair-colour-blond = rubio
phys-hair-colour-grey = canoso
phys-hair-colour-white = blanco
phys-hair-colour-none = ninguno
phys-hair-colour-other = otro
phys-build-slight = menuda
phys-build-slim = delgada
phys-build-average = media
phys-build-sturdy = fuerte
phys-build-stout = corpulenta
phys-build-heavy = pesada
phys-handedness-left = zurdo
phys-handedness-right = diestro
phys-handedness-ambidextrous = ambidiestro
phys-handedness-unknown = desconocida
phys-blood-group-a-pos = A positivo
phys-blood-group-a-neg = A negativo
phys-blood-group-b-pos = B positivo
phys-blood-group-b-neg = B negativo
phys-blood-group-ab-pos = AB positivo
phys-blood-group-ab-neg = AB negativo
phys-blood-group-o-pos = O positivo
phys-blood-group-o-neg = O negativo
phys-blood-group-unknown = desconocido
admin-export-with-health = Exportar con la salud
admin-export-health-note = La exportación omite los campos de salud y creencias, para que un archivo enviado a un pariente no lleve el historial médico de una persona viva. El segundo botón los incluye, para su propia copia.
...
silhouette-help-toggle = Qué muestra esta figura
silhouette-label = Edad y estatura registradas, no un aspecto
silhouette-not-a-likeness = No es un retrato: nada en ella procede de una fotografía.
silhouette-proportions-infant = Proporciones de un lactante, unas cuatro alturas de cabeza.
silhouette-proportions-child = Proporciones de un niño pequeño, unas seis alturas de cabeza.
silhouette-proportions-adolescent = Proporciones de un adolescente, unas siete alturas de cabeza.
silhouette-proportions-adult = Proporciones de un adulto, unas siete alturas y media de cabeza.
silhouette-proportions-elderly = Proporciones de un adulto, que dejan de cambiar hacia los veinte años: la figura no distingue a una persona mayor de una adulta más joven, y las fechas de arriba sí.
silhouette-to-scale = Dibujada a escala frente a una línea de referencia a { $ref } cm.
silhouette-no-height = No hay estatura registrada, así que la figura se dibuja a un tamaño nominal para su franja de edad y no a escala.
silhouette-several-heights = Hay más de una estatura registrada; la figura dibuja la más reciente.
