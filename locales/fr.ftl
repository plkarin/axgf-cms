...
phys-section-title = Corps et santé
phys-section-help = Ce que le dossier dit du corps d'une personne, et ce qu'il dit de sa santé. Chaque entrée porte la date à laquelle elle a été mesurée ou rapportée, car une taille à vingt ans et une taille à cinquante-six ans sont deux faits et non un fait corrigé.
phys-editor-title = Corps et santé
phys-traits-title = Traits physiques
phys-traits-help = Ce qu'inscrivent un passeport, un registre de conscription ou un dossier pénitentiaire. Ce ne sont pas des données médicales et elles ne sont pas traitées comme telles.
phys-health-title = Santé et convictions
phys-health-help = Affections, opérations, cause du décès, religion ou appartenance. Pour une personne vivante, ces éléments sont conservés mais visibles des seuls administrateurs.
phys-living-warning = Ce sont des données de santé concernant une personne vivante. Elles seront enregistrées dans le fichier et, tant que la fiche n'est pas marquée décédée, seuls les administrateurs les verront — ni le reste de la famille connectée, ni les visiteurs.
phys-living-shown-note = Vous voyez ceci parce que vous êtes administrateur ; les autres lecteurs ne le voient pas.
phys-health-withheld = Les données de santé de cette personne sont enregistrées mais réservées.
phys-health-withheld-editor = Les données de santé de cette personne vous sont réservées : elles ne sont pas affichées ici, et enregistrer ce formulaire les laissera intactes.
phys-health-locked-title = Ces données de santé ne sont pas les vôtres à modifier
phys-health-locked-detail = Cette fiche contient des données de santé que vous ne pouvez pas lire ; elles ne peuvent donc pas être modifiées depuis un formulaire qui ne les affichait pas. Un administrateur peut faire la modification.
phys-edit-link = Modifier corps et santé
phys-undated = sans date
phys-no-source = sans source
phys-date-placeholder = 1914 ou 1914-08
phys-col-value = Valeur
phys-col-date = Quand
...
phys-error-number = Une taille ou un poids est un nombre entier : centimètres, kilogrammes.
phys-error-range = Cette taille ou ce poids sort de ce qu'un dossier pourrait vouloir dire.
phys-error-vocabulary = Ce n'est pas une des valeurs proposées.
phys-error-confidence = La confiance va de 0 à 1, par exemple 0,8.
...
phys-eye-colour-brown = marron
phys-eye-colour-hazel = noisette
phys-eye-colour-amber = ambre
phys-eye-colour-green = verts
phys-eye-colour-blue = bleus
phys-eye-colour-grey = gris
phys-eye-colour-mixed = mêlés
phys-eye-colour-other = autre
phys-hair-colour-black = noirs
phys-hair-colour-brown = châtains
phys-hair-colour-auburn = auburn
phys-hair-colour-red = roux
phys-hair-colour-fair = clairs
phys-hair-colour-blond = blonds
phys-hair-colour-grey = gris
phys-hair-colour-white = blancs
phys-hair-colour-none = aucun
phys-hair-colour-other = autre
phys-build-slight = frêle
phys-build-slim = mince
phys-build-average = moyenne
phys-build-sturdy = robuste
phys-build-stout = corpulente
phys-build-heavy = forte
phys-handedness-left = gaucher
phys-handedness-right = droitier
phys-handedness-ambidextrous = ambidextre
phys-handedness-unknown = inconnue
phys-blood-group-a-pos = A positif
phys-blood-group-a-neg = A négatif
phys-blood-group-b-pos = B positif
phys-blood-group-b-neg = B négatif
phys-blood-group-ab-pos = AB positif
phys-blood-group-ab-neg = AB négatif
