...
phys-section-title = Corpo e salute
phys-section-help = Ciò che la scheda dice del corpo di una persona e ciò che dice della sua salute. Ogni voce porta la data in cui è stata misurata o riferita, perché una statura a vent'anni e una a cinquantasei sono due fatti e non uno corretto.
phys-editor-title = Corpo e salute
phys-traits-title = Tratti fisici
phys-traits-help = Ciò che annotano un passaporto, un registro di leva o un fascicolo carcerario. Non sono dati medici e non sono trattati come tali.
phys-health-title = Salute e convinzioni
phys-health-help = Malattie, operazioni, causa della morte, religione o appartenenza. Per una persona vivente sono conservati ma visibili ai soli amministratori.
phys-living-warning = Questi sono dati sanitari di una persona vivente. Saranno conservati nel pacchetto e, finché la scheda non è segnata come deceduta, li vedranno soltanto gli amministratori — non il resto della famiglia autenticata né i visitatori.
phys-living-shown-note = Lo vedi perché sei amministratore; gli altri lettori no.
phys-health-withheld = I dati sanitari di questa persona sono registrati ma riservati.
phys-health-withheld-editor = I dati sanitari di questa persona ti sono riservati, quindi non compaiono qui e salvare questo modulo li lascerà intatti.
phys-health-locked-title = Questi dati sanitari non spetta a te cambiarli
phys-health-locked-detail = Questa scheda contiene dati sanitari che non puoi leggere, quindi non possono essere modificati da un modulo che non li ha mostrati. Un amministratore può fare la modifica.
phys-edit-link = Modifica corpo e salute
phys-undated = senza data
phys-no-source = senza fonte
phys-date-placeholder = 1914 oppure 1914-08
phys-col-value = Valore
...
phys-error-number = Statura e peso sono numeri interi: centimetri, chilogrammi.
phys-error-range = Quella statura o quel peso sta fuori da ciò che una scheda potrebbe intendere.
phys-error-vocabulary = Non è uno dei valori elencati.
phys-error-confidence = L'attendibilità va da 0 a 1, per esempio 0,8.
...
phys-eye-colour-brown = marroni
phys-eye-colour-hazel = nocciola
phys-eye-colour-amber = ambra
phys-eye-colour-green = verdi
phys-eye-colour-blue = azzurri
phys-eye-colour-grey = grigi
phys-eye-colour-mixed = misti
phys-eye-colour-other = altro
phys-hair-colour-black = neri
phys-hair-colour-brown = castani
phys-hair-colour-auburn = ramati
phys-hair-colour-red = rossi
phys-hair-colour-fair = chiari
phys-hair-colour-blond = biondi
phys-hair-colour-grey = grigi
phys-hair-colour-white = bianchi
phys-hair-colour-none = nessuno
phys-hair-colour-other = altro
phys-build-slight = esile
phys-build-slim = snella
phys-build-average = media
phys-build-sturdy = robusta
phys-build-stout = corpulenta
phys-build-heavy = pesante
phys-handedness-left = mancino
phys-handedness-right = destrimano
phys-handedness-ambidextrous = ambidestro
phys-handedness-unknown = ignota
...
phys-blood-group-o-pos = 0 positivo
phys-blood-group-o-neg = 0 negativo
phys-blood-group-unknown = ignoto
admin-export-with-health = Esporta con la salute
admin-export-health-note = L'esportazione tralascia i campi di salute e convinzione, così un pacchetto inviato a un parente non porta con sé la storia clinica di una persona vivente. Il secondo pulsante li include, per la tua copia.
...
## La figura generata accanto a una scheda
#
...
silhouette-proportions-child = Proporzioni di un bambino piccolo, circa sei altezze di testa.
silhouette-proportions-adolescent = Proporzioni di un adolescente, circa sette altezze di testa.
silhouette-proportions-adult = Proporzioni di un adulto, circa sette altezze di testa e mezza.
silhouette-proportions-elderly = Proporzioni di un adulto, che smettono di cambiare intorno ai vent'anni: la figura non distingue un anziano da un adulto più giovane, mentre le date qui sopra lo fanno.
silhouette-to-scale = Disegnata in scala rispetto a una linea di riferimento a { $ref } cm.
silhouette-no-height = Nessuna statura è registrata, perciò la figura è disegnata a una dimensione nominale per la sua fascia d'età e non in scala.
silhouette-several-heights = È registrata più di una statura; la figura disegna la più recente.
