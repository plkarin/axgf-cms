...
phys-section-title = からだと健康
phys-section-help = 記録がその人のからだについて述べていること、そして健康について述べていること。どの項目にも測定・報告された日付が付きます。二十歳の身長と五十六歳の身長は、訂正された一つの事実ではなく二つの事実だからです。
phys-editor-title = からだと健康
phys-traits-title = 身体的特徴
phys-traits-help = 旅券や徴兵名簿、獄中記録が書きとめる事柄。医療データではなく、ここでもそう扱いません。
phys-health-title = 健康と信条
phys-health-help = 疾患、手術、死因、宗教または所属。存命の人については保存されますが、管理者だけが見られます。
phys-living-warning = これは存命の人の健康データです。バンドルに保存され、記録が故人と記されるまでは管理者だけが見られます。ログイン済みの他の家族にも、訪問者にも表示されません。
phys-living-shown-note = 管理者であるため表示されています。他の閲覧者には見えません。
phys-health-withheld = この人の健康に関する記載はありますが、伏せられています。
phys-health-withheld-editor = この人の健康に関する記載はあなたには伏せられているためここには表示されず、この書式を保存しても変更されません。
phys-health-locked-title = この健康データを変更する権限はありません
phys-health-locked-detail = この記録には閲覧できない健康データが含まれるため、それを表示しなかった書式からは編集できません。変更は管理者が行えます。
phys-edit-link = からだと健康を編集
phys-undated = 日付なし
phys-no-source = 出典なし
phys-date-placeholder = 1914 または 1914-08
phys-col-value = 値
phys-col-date = 時期
phys-col-source = 出典
...
phys-error-number = 身長と体重は整数です。センチメートル、キログラムで入力してください。
phys-error-range = その身長または体重は、記録が意味しうる範囲を外れています。
phys-error-vocabulary = 一覧にある値ではありません。
phys-error-confidence = 確度は 0 から 1 までです。たとえば 0.8。
...
phys-eye-colour-brown = 茶
phys-eye-colour-hazel = 淡褐
phys-eye-colour-amber = 琥珀
phys-eye-colour-green = 緑
phys-eye-colour-blue = 青
phys-eye-colour-grey = 灰
phys-eye-colour-mixed = 混合
phys-eye-colour-other = その他
phys-hair-colour-black = 黒
phys-hair-colour-brown = 茶
phys-hair-colour-auburn = 赤褐
phys-hair-colour-red = 赤
phys-hair-colour-fair = 淡色
phys-hair-colour-blond = 金
phys-hair-colour-grey = 白髪まじり
phys-hair-colour-white = 白
phys-hair-colour-none = なし
phys-hair-colour-other = その他
phys-build-slight = 華奢
phys-build-slim = 細身
phys-build-average = 中肉
phys-build-sturdy = 頑健
phys-build-stout = がっしり
phys-build-heavy = 重量
phys-handedness-left = 左利き
phys-handedness-right = 右利き
phys-handedness-ambidextrous = 両利き
phys-handedness-unknown = 不明
phys-blood-group-a-pos = A 型 Rh 陽性
phys-blood-group-a-neg = A 型 Rh 陰性
phys-blood-group-b-pos = B 型 Rh 陽性
phys-blood-group-b-neg = B 型 Rh 陰性
phys-blood-group-ab-pos = AB 型 Rh 陽性
phys-blood-group-ab-neg = AB 型 Rh 陰性
