...
phys-section-title = Ciało i zdrowie
phys-section-help = Co zapis mówi o ciele osoby i co mówi o jej zdrowiu. Każdy wpis ma datę pomiaru lub zgłoszenia, bo wzrost w wieku dwudziestu lat i wzrost w wieku pięćdziesięciu sześciu to dwa fakty, a nie jeden poprawiony.
phys-editor-title = Ciało i zdrowie
phys-traits-title = Cechy fizyczne
phys-traits-help = To, co wpisuje paszport, księga poborowa albo akta więzienne. Nie są to dane medyczne i nie są tak traktowane.
phys-health-title = Zdrowie i wyznanie
phys-health-help = Choroby, operacje, przyczyna zgonu oraz religia lub przynależność. U osoby żyjącej dane te są przechowywane, ale widzą je tylko administratorzy.
phys-living-warning = To są dane o zdrowiu osoby żyjącej. Zostaną zapisane w pakiecie i do czasu oznaczenia zapisu jako zmarły zobaczą je wyłącznie administratorzy — nie inni zalogowani członkowie rodziny ani odwiedzający.
phys-living-shown-note = Widzisz to, ponieważ jesteś administratorem; inni czytelnicy tego nie widzą.
phys-health-withheld = Dane o zdrowiu tej osoby są zapisane, ale zastrzeżone.
phys-health-withheld-editor = Dane o zdrowiu tej osoby są przed Tobą zastrzeżone, więc nie są tu pokazane, a zapisanie tego formularza ich nie zmieni.
phys-health-locked-title = Nie możesz zmieniać tych danych o zdrowiu
phys-health-locked-detail = Ten zapis zawiera dane o zdrowiu, których nie możesz odczytać, więc nie da się ich edytować w formularzu, który ich nie pokazał. Zmiany może dokonać administrator.
phys-edit-link = Edytuj ciało i zdrowie
phys-undated = bez daty
phys-no-source = bez źródła
phys-date-placeholder = 1914 albo 1914-08
phys-col-value = Wartość
phys-col-date = Kiedy
...
phys-error-number = Wzrost i waga to liczby całkowite: centymetry, kilogramy.
phys-error-range = Taki wzrost lub taka waga wykraczają poza to, co zapis mógłby oznaczać.
phys-error-vocabulary = To nie jest jedna z wymienionych wartości.
phys-error-confidence = Pewność mieści się w przedziale od 0 do 1, na przykład 0,8.
...
phys-eye-colour-brown = piwne
phys-eye-colour-hazel = orzechowe
phys-eye-colour-amber = bursztynowe
phys-eye-colour-green = zielone
phys-eye-colour-blue = niebieskie
phys-eye-colour-grey = szare
phys-eye-colour-mixed = mieszane
phys-eye-colour-other = inne
phys-hair-colour-black = czarne
phys-hair-colour-brown = brązowe
phys-hair-colour-auburn = kasztanowe
phys-hair-colour-red = rude
phys-hair-colour-fair = jasne
phys-hair-colour-blond = blond
phys-hair-colour-grey = siwe
phys-hair-colour-white = białe
phys-hair-colour-none = brak
phys-hair-colour-other = inne
phys-build-slight = drobna
phys-build-slim = szczupła
phys-build-average = przeciętna
phys-build-sturdy = krzepka
phys-build-stout = tęga
phys-build-heavy = ciężka
phys-handedness-left = leworęczność
phys-handedness-right = praworęczność
phys-handedness-ambidextrous = oburęczność
phys-handedness-unknown = nieznana
phys-blood-group-a-pos = A Rh dodatnia
phys-blood-group-a-neg = A Rh ujemna
phys-blood-group-b-pos = B Rh dodatnia
phys-blood-group-b-neg = B Rh ujemna
phys-blood-group-ab-pos = AB Rh dodatnia
phys-blood-group-ab-neg = AB Rh ujemna
