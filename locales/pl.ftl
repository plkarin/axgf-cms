...
diff-section-other = inne pole
diff-section-avatar = Zdjęcie portretowe
diff-section-partners = Partnerzy
diff-section-ai = Wsparcie AI
diff-section-birth = Narodziny
diff-section-civil-status = Stan cywilny
diff-section-documents = Załączone dokumenty
diff-section-extensions = Dane aplikacji
diff-section-children = Dzieci
diff-section-union = Związek
diff-section-date = Data
diff-section-participants = Uczestnicy
diff-section-from = Powiązanie od
diff-section-to = Powiązanie z
diff-section-valid-from = Ważne od
diff-section-valid-until = Ważne do
diff-section-visibility = Widoczność
diff-section-employer = Pracodawca
diff-section-title-normalized = Tytuł znormalizowany
diff-section-conflicts = Sprzeczne źródła
diff-section-dna = DNA
diff-section-document = Dokument
diff-section-language = Język
diff-section-place = Miejsce
diff-section-repository = Archiwum
diff-section-script = Pismo
diff-section-coordinates = Współrzędne
diff-section-country-history = Historia państw
diff-section-identifiers = Identyfikatory
diff-section-names = Nazwy
diff-section-file = Plik
diff-section-linked-to = Dołączony do
diff-section-ocr = Rozpoznany tekst
diff-section-format-version = Wersja formatu
