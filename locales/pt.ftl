...
phys-section-title = Corpo e saúde
phys-section-help = O que o registo diz do corpo de uma pessoa e o que diz da sua saúde. Cada entrada leva a data em que foi medida ou relatada, porque uma altura aos vinte e outra aos cinquenta e seis são dois factos e não um corrigido.
phys-editor-title = Corpo e saúde
phys-traits-title = Traços físicos
phys-traits-help = O que um passaporte, um registo de recrutamento ou um processo prisional escrevem. Não são dados médicos nem são tratados como tal.
phys-health-title = Saúde e crenças
phys-health-help = Doenças, operações, causa da morte e religião ou filiação. Numa pessoa viva ficam guardados mas só os administradores os veem.
phys-living-warning = Estes são dados de saúde de uma pessoa viva. Serão guardados no ficheiro e, até o registo ser marcado como falecido, só os administradores os verão — nem a restante família autenticada nem os visitantes.
phys-living-shown-note = Vê isto porque é administrador; os outros leitores não.
phys-health-withheld = Os dados de saúde desta pessoa estão registados mas reservados.
phys-health-withheld-editor = Os dados de saúde desta pessoa estão-lhe reservados, por isso não são mostrados aqui e guardar este formulário deixá-los-á intactos.
phys-health-locked-title = Não lhe cabe alterar estes dados de saúde
phys-health-locked-detail = Este registo contém dados de saúde que não pode ler, por isso não podem ser editados a partir de um formulário que não os mostrou. Um administrador pode fazer a alteração.
phys-edit-link = Editar corpo e saúde
phys-undated = sem data
phys-no-source = sem fonte
phys-date-placeholder = 1914 ou 1914-08
...
phys-error-number = Uma altura ou um peso é um número inteiro: centímetros, quilogramas.
phys-error-range = Essa altura ou esse peso está fora do que um registo poderia querer dizer.
phys-error-vocabulary = Esse não é um dos valores listados.
phys-error-confidence = A confiança vai de 0 a 1, por exemplo 0,8.
...
phys-eye-colour-brown = castanhos
phys-eye-colour-hazel = cor de avelã
phys-eye-colour-amber = âmbar
phys-eye-colour-green = verdes
phys-eye-colour-blue = azuis
phys-eye-colour-grey = cinzentos
phys-eye-colour-mixed = mistos
phys-eye-colour-other = outra
phys-hair-colour-black = pretos
phys-hair-colour-brown = castanhos
phys-hair-colour-auburn = acastanhados
phys-hair-colour-red = ruivos
phys-hair-colour-fair = claros
phys-hair-colour-blond = louros
phys-hair-colour-grey = grisalhos
phys-hair-colour-white = brancos
phys-hair-colour-none = nenhum
phys-hair-colour-other = outra
phys-build-slight = franzina
phys-build-slim = magra
phys-build-average = média
phys-build-sturdy = robusta
phys-build-stout = corpulenta
phys-build-heavy = pesada
phys-handedness-left = canhoto
phys-handedness-right = destro
phys-handedness-ambidextrous = ambidestro
phys-handedness-unknown = desconhecida
...
phys-blood-group-unknown = desconhecido
admin-export-with-health = Exportar com a saúde
admin-export-health-note = A exportação deixa de fora os campos de saúde e crença, para que um ficheiro enviado a um familiar não leve o historial médico de uma pessoa viva. O segundo botão inclui-os, para a sua própria cópia.
...
silhouette-help-toggle = O que esta figura mostra
