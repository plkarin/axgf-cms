...
phys-section-title = Тело и здоровье
phys-section-help = Что запись говорит о теле человека и что — о его здоровье. У каждой записи есть дата измерения или сообщения, потому что рост в двадцать лет и рост в пятьдесят шесть — это два факта, а не один исправленный.
phys-editor-title = Тело и здоровье
phys-traits-title = Физические черты
phys-traits-help = То, что заносят паспорт, призывная книга или тюремное дело. Это не медицинские данные и здесь они таковыми не считаются.
phys-health-title = Здоровье и убеждения
phys-health-help = Заболевания, операции, причина смерти, вероисповедание или принадлежность. У живущего человека они хранятся, но видны только администраторам.
phys-living-warning = Это данные о здоровье живущего человека. Они будут сохранены в архиве, и пока запись не помечена как умерший, их увидят только администраторы — ни остальные вошедшие родственники, ни посетители.
phys-living-shown-note = Вы видите это потому, что вы администратор; другим читателям это не показано.
phys-health-withheld = Сведения о здоровье этого человека записаны, но закрыты.
phys-health-withheld-editor = Сведения о здоровье этого человека от вас закрыты, поэтому здесь не показаны, и сохранение этой формы их не изменит.
phys-health-locked-title = Эти сведения о здоровье менять не вам
phys-health-locked-detail = В этой записи есть данные о здоровье, которые вам недоступны, поэтому их нельзя править через форму, которая их не показывала. Изменение может внести администратор.
phys-edit-link = Изменить тело и здоровье
phys-undated = без даты
phys-no-source = без источника
phys-date-placeholder = 1914 или 1914-08
phys-col-value = Значение
phys-col-date = Когда
...
phys-unit-cm = { $n } см
phys-unit-kg = { $n } кг
phys-unit-cm-short = см
phys-unit-kg-short = кг
phys-error-number = Рост и вес — целые числа: сантиметры, килограммы.
phys-error-range = Такой рост или вес выходит за пределы того, что могла бы означать запись.
phys-error-vocabulary = Это не одно из перечисленных значений.
phys-error-confidence = Достоверность лежит от 0 до 1, например 0,8.
...
phys-eye-colour-brown = карие
phys-eye-colour-hazel = ореховые
phys-eye-colour-amber = янтарные
phys-eye-colour-green = зелёные
phys-eye-colour-blue = голубые
phys-eye-colour-grey = серые
phys-eye-colour-mixed = смешанные
phys-eye-colour-other = другие
phys-hair-colour-black = чёрные
phys-hair-colour-brown = каштановые
phys-hair-colour-auburn = тёмно-рыжие
phys-hair-colour-red = рыжие
phys-hair-colour-fair = светлые
phys-hair-colour-blond = белокурые
phys-hair-colour-grey = седые
phys-hair-colour-white = белые
phys-hair-colour-none = нет
phys-hair-colour-other = другие
phys-build-slight = хрупкое
phys-build-slim = худощавое
phys-build-average = среднее
phys-build-sturdy = крепкое
phys-build-stout = плотное
phys-build-heavy = грузное
phys-handedness-left = левша
phys-handedness-right = правша
phys-handedness-ambidextrous = обе руки
phys-handedness-unknown = неизвестно
phys-blood-group-a-pos = A положительная
phys-blood-group-a-neg = A отрицательная
phys-blood-group-b-pos = B положительная
phys-blood-group-b-neg = B отрицательная
phys-blood-group-ab-pos = AB положительная
phys-blood-group-ab-neg = AB отрицательная
phys-blood-group-o-pos = O положительная
phys-blood-group-o-neg = O отрицательная
phys-blood-group-unknown = неизвестна
admin-export-with-health = Экспорт вместе со здоровьем
admin-export-health-note = Экспорт опускает поля здоровья и убеждений, чтобы отправленный родственнику архив не нёс медицинскую историю живущего человека. Вторая кнопка их включает — для собственной резервной копии.
...
silhouette-help-toggle = Что показывает этот рисунок
