...
phys-section-title = 身体与健康
phys-section-help = 记录对一个人身体的记载，以及对其健康的记载。每一条都带有测量或报告的日期，因为二十岁的身高和五十六岁的身高是两个事实，而不是一个事实的更正。
phys-editor-title = 身体与健康
phys-traits-title = 身体特征
phys-traits-help = 护照、征兵名册或狱中档案会写下的内容。这不是医疗数据，此处也不按医疗数据对待。
phys-health-title = 健康与信仰
phys-health-help = 疾病、手术、死因，以及宗教或所属。对在世者，这些会被保存，但仅管理员可见。
phys-living-warning = 这是在世者的健康数据。它会存入档案包；在该记录被标记为已故之前，只有管理员能看到——已登录的其他家人看不到，访客也看不到。
phys-living-shown-note = 你能看到这些是因为你是管理员；其他读者看不到。
phys-health-withheld = 此人的健康记载存在，但已被隐去。
phys-health-withheld-editor = 此人的健康记载对你隐去，因此这里不显示，保存此表单也不会改动它们。
phys-health-locked-title = 这些健康数据不该由你更改
phys-health-locked-detail = 该记录含有你无权读取的健康数据，因此不能通过一份没有显示它们的表单来编辑。可由管理员进行更改。
phys-edit-link = 编辑身体与健康
phys-undated = 无日期
phys-no-source = 无来源
phys-date-placeholder = 1914 或 1914-08
phys-col-value = 值
phys-col-date = 何时
phys-col-source = 来源
...
phys-unit-cm = { $n } 厘米
phys-unit-kg = { $n } 公斤
phys-unit-cm-short = 厘米
phys-unit-kg-short = 公斤
phys-error-number = 身高和体重是整数：厘米、公斤。
phys-error-range = 该身高或体重超出了记录可能表达的范围。
phys-error-vocabulary = 这不是所列值之一。
phys-error-confidence = 可信度取值 0 到 1，例如 0.8。
...
phys-eye-colour-brown = 褐色
phys-eye-colour-hazel = 淡褐色
phys-eye-colour-amber = 琥珀色
phys-eye-colour-green = 绿色
phys-eye-colour-blue = 蓝色
phys-eye-colour-grey = 灰色
phys-eye-colour-mixed = 混合
phys-eye-colour-other = 其他
phys-hair-colour-black = 黑色
phys-hair-colour-brown = 棕色
phys-hair-colour-auburn = 赤褐色
phys-hair-colour-red = 红色
phys-hair-colour-fair = 浅色
phys-hair-colour-blond = 金色
phys-hair-colour-grey = 灰白
phys-hair-colour-white = 白色
phys-hair-colour-none = 无
phys-hair-colour-other = 其他
phys-build-slight = 纤弱
phys-build-slim = 瘦削
phys-build-average = 中等
phys-build-sturdy = 结实
phys-build-stout = 壮实
phys-build-heavy = 魁梧
phys-handedness-left = 左利手
phys-handedness-right = 右利手
phys-handedness-ambidextrous = 双手俱利
phys-handedness-unknown = 不详
phys-blood-group-a-pos = A 型 Rh 阳性
phys-blood-group-a-neg = A 型 Rh 阴性
phys-blood-group-b-pos = B 型 Rh 阳性
phys-blood-group-b-neg = B 型 Rh 阴性
phys-blood-group-ab-pos = AB 型 Rh 阳性
phys-blood-group-ab-neg = AB 型 Rh 阴性
